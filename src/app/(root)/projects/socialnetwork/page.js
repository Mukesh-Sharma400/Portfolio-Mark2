...
export default function SocialNetwork() {
  ...
  return (
    <BaseLayout>
      ...
      <Description>
        Discover a powerful MERN stack social network app, fueled by MongoDB,
        ExpressJS, ReactJS, and NodeJS. Experience seamless media management
        with Cloudinary integration and efficient email communication through
        SendGrid Email API. Leveraging React Hooks, CORS, Context/RESTful API,
