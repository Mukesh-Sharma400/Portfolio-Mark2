  ...
  return (
    <BaseLayout>
      ...
      <Description>
        ...
        Harnessing MongoDB for data storage, ExpressJS for server-side
        development, ReactJS for dynamic user interfaces, and NodeJS for backend
        support. Integrated with Google OAuth for seamless login, Redux and
        Redux-Thunk for state management, and enhanced with React Hooks and CORS
        for flexibility. Delve into our rich feature set and unleash the
        potential of Context/RESTful API integration. Unleash your memories
        today!
      </Description>
      <ButtonsWrapper>
